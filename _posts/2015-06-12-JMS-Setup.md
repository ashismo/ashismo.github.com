...
Note that both **com.ashish.jms.sender.JMSSender** and **com.ashish.jms.receiver.JMSReceiver** classes have main() method because we need to run sender and receiver program one after another. Programs will stop once sender sends **quit** in the stream from the sender
