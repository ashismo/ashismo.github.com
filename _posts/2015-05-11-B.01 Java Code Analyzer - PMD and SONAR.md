...
Otherwise follow the below steps
 ...
 <li> Right click on some project and check if PMD is getting displayed on the popup.</li> 
 <br/>
<img src="http://www.eclipsezone.com/articles/pmd/images/check_code_pmd.png" height="300" width="250"> <br/>
</ul>
