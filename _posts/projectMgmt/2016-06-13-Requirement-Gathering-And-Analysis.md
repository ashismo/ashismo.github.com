...
* In interface analysis, the description of each interface, batch feed, transactional files and interfaces to and from the systems are very important factors.
